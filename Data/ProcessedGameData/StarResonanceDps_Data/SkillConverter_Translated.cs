namespace StarResonanceDpsAnalysis.Core
{
    ...
    // Patched to english using the SkillTable.json / BuffTable.json / RecountTable.json anything left was translated using DeepL and marked with (T)
    ...
    public static class EmbeddedSkillConfig
    {
        ...
        public static readonly Dictionary<string, SkillDefinition> SkillsByString = new()
        {
            ...
            ["31901"] = new SkillDefinition { Name = "Gale Assault", Type = SkillType.Damage, Element = ElementType.Wind, Description = "勇气风环" },
            ["2205450"] = new SkillDefinition { Name = "Resolute (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "勇气风环吸血" },
            ...
            ["140401"] = new SkillDefinition { Name = "Gravitational Impact (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "龙击炮" },
            ["2205071"] = new SkillDefinition { Name = "Unconventional Skill: Instant Return - Tear (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "撕裂" },
            ["149901"] = new SkillDefinition { Name = "Tina Wind Core (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "风螺旋/螺旋引爆" },
            ...
            ["149905"] = new SkillDefinition { Name = "Tina Bird Throw (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "飞鸟投" },
            ["1433"] = new SkillDefinition { Name = "Falcon Strike", Type = SkillType.Damage, Element = ElementType.Wind, Description = "极·岚切" },
            ["149906"] = new SkillDefinition { Name = "Tina's Enhanced Flying Bird Shot (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "极·岚切" },
            ["149907"] = new SkillDefinition { Name = "Tina's Sharp Impact Segment (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "锐利冲击(风神)" },
            ["1431"] = new SkillDefinition { Name = "Sharp Impact", Type = SkillType.Damage, Element = ElementType.Wind, Description = "锐利冲击(风神)" },
            ["149902"] = new SkillDefinition { Name = "Tina's Gun Array (T)", Type = SkillType.Damage, Element = ElementType.Wind, Description = "长矛贯穿" },
            ...
            ["1735"] = new SkillDefinition { Name = "Dragonhammer", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "坠龙闪" },
            ["1736"] = new SkillDefinition { Name = "Raijin Dash Slash", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "神影斩" },
            ["155101"] = new SkillDefinition { Name = "Lightning Cut (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "雷切" },
            ...
            ["1739"] = new SkillDefinition { Name = "Olvira triggered a Heart's Eye Strike. (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "看破斩" },
            ...
            ["1742"] = new SkillDefinition { Name = "Thundercut - Final Slash", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "霹雳升龙斩" },
            ["44701"] = new SkillDefinition { Name = "Scythe damage (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "月刃" },
            ["179908"] = new SkillDefinition { Name = "Olvera Lightning Strike (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "雷击" },
            ["179906"] = new SkillDefinition { Name = "Olvera's Spinning Attack (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "月刃回旋" },
            ["2031101"] = new SkillDefinition { Name = "Blade - Luck", Type = SkillType.Damage, Element = ElementType.Light, Description = "幸运一击(太刀)" },

            ["2330"] = new SkillDefinition { Name = "Soul Musician Yanwu Performer Enhancement (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "火柱冲击" },
            ["55314"] = new SkillDefinition { Name = "Torrent", Type = SkillType.Heal, Element = ElementType.Fire, Description = "安可治疗" },
            ["230101"] = new SkillDefinition { Name = "Aggregate Movement, Single Movement (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "聚合乐章/安可治疗相关" },
            ["230401"] = new SkillDefinition { Name = "Encore Damage (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "安可伤害" },
            ["230501"] = new SkillDefinition { Name = "Infinite Chain Encore Damage (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "无限连奏安可伤害" },
            ...
            ["2331"] = new SkillDefinition { Name = "Soul Musician's Soundwave Blaze (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "音浪" },
            ["2335"] = new SkillDefinition { Name = "Infinite Rhapsody", Type = SkillType.Damage, Element = ElementType.Fire, Description = "无限狂想伤害" },
            ["230102"] = new SkillDefinition { Name = "Aggregate Movement II (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "聚合乐章" },
            ["230103"] = new SkillDefinition { Name = "Three Movements of the Polyphonic Symphony (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "聚合乐章" },
            ["230104"] = new SkillDefinition { Name = "Four Movements of the Polyphonic Symphony (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "聚合乐章" },
            ["230105"] = new SkillDefinition { Name = "Fiery Rhythm Stomp (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "炎律狂踏伤害" },
            ["230106"] = new SkillDefinition { Name = "Fiery Notes(T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "烈焰音符伤害" },
            ["231001"] = new SkillDefinition { Name = "Blazing Fantasy Damage (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "烈焰狂想伤害" },
            ["55301"] = new SkillDefinition { Name = "Blazing Fantasy: Health Regeneration (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "烈焰狂想治疗" },
            ["55311"] = new SkillDefinition { Name = "Soul Musician's innate resource regeneration buff (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "安可曲转化" },
            ["55341"] = new SkillDefinition { Name = "Wild Melody Therapy (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "英勇乐章治疗" },
            ["55346"] = new SkillDefinition { Name = "Maximum Healing from Ultimate Ability (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "无限狂想治疗" },
            ["55355"] = new SkillDefinition { Name = "Basic Attack: First and Second Hits Restore Health (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "休止的治愈" },
            ["2207141"] = new SkillDefinition { Name = "Dual Melody Therapy (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "音符" },
            ["2207151"] = new SkillDefinition { Name = "Blazing Flame Healing (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "炽焰治愈" },
            ["2207431"] = new SkillDefinition { Name = "Enhanced beat effect (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "炎律狂踏治疗" },
            ...
            ["55302"] = new SkillDefinition { Name = "Special Attack B Restores HP (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "愈合节拍" },
            ["55304"] = new SkillDefinition { Name = "Surge Quintet Therapy (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "激涌五重奏治疗" },
            ["55339"] = new SkillDefinition { Name = "Ultimate Ability B: Healing (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "巡演曲治疗" },
            ["55342"] = new SkillDefinition { Name = "Sound Therapy for Serenity (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "愈合乐章治疗" },
            ["2207620"] = new SkillDefinition { Name = "Vitality Reserve (T)", Type = SkillType.Heal, Element = ElementType.Fire, Description = "活力解放" },

            ["1501"] = new SkillDefinition { Name = "Vines' Embrace", Type = SkillType.Damage, Element = ElementType.Earth, Description = "掌控藤曼" },
            ["1502"] = new SkillDefinition { Name = "Eluna ATK_02 (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "掌控藤曼" },
            ["1503"] = new SkillDefinition { Name = "Eluna ATK_03 (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "掌控藤曼" },
            ["1504"] = new SkillDefinition { Name = "Eluna ATK_04 (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "掌控藤曼" },
            ...
            ["1551"] = new SkillDefinition { Name = "Talent Trigger - Seed Meteorite (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "狂野之种" },
            ...
            ["20301"] = new SkillDefinition { Name = "Therapeutic effect (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "生命绽放" },
            ["21402"] = new SkillDefinition { Name = "Special Attack Treatment (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "狂野绽放治疗" },
            ["21404"] = new SkillDefinition { Name = "HP Regen", Type = SkillType.Heal, Element = ElementType.Earth, Description = "滋养" },
            ["21406"] = new SkillDefinition { Name = "Restore (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "森之祈愿" },
            ["21414"] = new SkillDefinition { Name = "Shelter Zone with Grass (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "希望结界持续(包含伤害和治疗)" },
            ["21427"] = new SkillDefinition { Name = "Basic Attack: 1-hit Health Regeneration (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "休止的治愈" },
            ["21428"] = new SkillDefinition { Name = "Basic Attack: 2-stage health regeneration (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "休止的治愈" },
            ["21429"] = new SkillDefinition { Name = "Basic Attack: 3-hit health regeneration (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "休止的治愈" },
            ["21430"] = new SkillDefinition { Name = "Basic Attack: 4-hit health regeneration (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "休止的治愈" },
            ["150103"] = new SkillDefinition { Name = "Unrestrained Seed (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "不羁之种" },
            ["150104"] = new SkillDefinition { Name = "Unrestrained Seed (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "不羁之种" },
            ...
            ["2031005"] = new SkillDefinition { Name = "Ring of Law - Intelligence (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "幸运一击(森语者)" },
            ["2202091"] = new SkillDefinition { Name = "Chain Buff Treatment (T)", Type = SkillType.Heal, Element = ElementType.Earth, Description = "治疗链接" },
            ...
            ["150101"] = new SkillDefinition { Name = "Eluna Summon Beast ATK_01 (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "鹿之奔袭" },
            ["150110"] = new SkillDefinition { Name = "infusion", Type = SkillType.Heal, Element = ElementType.Earth, Description = "灌注" },

            ["2031105"] = new SkillDefinition { Name = "Rune Ring - Luck", Type = SkillType.Damage, Element = ElementType.Light, Description = "幸运一击(惩戒)" },
            ["220101"] = new SkillDefinition { Name = "Never misses a shot (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "弹无虚发" },
            ["220103"] = new SkillDefinition { Name = "Never misses a shot (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "弹无虚发" },
            ...
            ["2291"] = new SkillDefinition { Name = "Rotoliani - Bow - Ultimate Explosion Rotoloyani - Bow - Ultimate Explosion (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "锐眼·光能巨箭(天赋)" },
            ["2289"] = new SkillDefinition { Name = "Arrow Rain Virtual Entity (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "箭雨" },
            ["2233"] = new SkillDefinition { Name = "Powerdraw", Type = SkillType.Damage, Element = ElementType.Light, Description = "聚能射击" },
            ["2288"] = new SkillDefinition { Name = "Energy-Focused Virtual Shooting", Type = SkillType.Damage, Element = ElementType.Light, Description = "光能轰炸" },
            ["220102"] = new SkillDefinition { Name = "Raging Tide Shooting", Type = SkillType.Damage, Element = ElementType.Earth, Description = "怒涛射击" },
            ["220108"] = new SkillDefinition { Name = "Explosive Arrow", Type = SkillType.Damage, Element = ElementType.Fire, Description = "爆炸箭矢" },
            ["220109"] = new SkillDefinition { Name = "Deterrent fire", Type = SkillType.Damage, Element = ElementType.Earth, Description = "威慑射击" },
            ["1700820"] = new SkillDefinition { Name = "Pet - Groundhog Bite (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "狼协同攻击" },
            ["1700827"] = new SkillDefinition { Name = "Companion - Basic Attack", Type = SkillType.Damage, Element = ElementType.Earth, Description = "狼普攻" },
            ["2292"] = new SkillDefinition { Name = "Phantom Direwolves", Type = SkillType.Damage, Element = ElementType.Earth, Description = "扑咬" },
            ["2203512"] = new SkillDefinition { Name = "Feral Call Trample - Sub-Buff 2 Damage (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "践踏" },
            ["55231"] = new SkillDefinition { Name = "Explosive Arrow BUFF", Type = SkillType.Damage, Element = ElementType.Fire, Description = "爆炸射击" },
            ["220110"] = new SkillDefinition { Name = "Explosive Arrow Detonation (T)", Type = SkillType.Damage, Element = ElementType.Fire, Description = "爆炸箭引爆" },
            ...
            ["2203621"] = new SkillDefinition { Name = "Lightning Chain - Supervisor BUFF (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光棱" },
            ["2203622"] = new SkillDefinition { Name = "Lightning-Derived Buff - Test (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光棱溅射" },
            ["220112"] = new SkillDefinition { Name = "Light Energy Fissure (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光能裂隙" },
            ["220106"] = new SkillDefinition { Name = "Double-shot (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "二连矢" },
            ["2203521"] = new SkillDefinition { Name = "Steel Beak BUFF Stack (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "内爆(钢制喙触发)" },
            ["2203181"] = new SkillDefinition { Name = "Eagle Eye Lightning Strike - Sub-Buff (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "闪电冲击" },
            ["2294"] = new SkillDefinition { Name = "Lethal Shot", Type = SkillType.Damage, Element = ElementType.Light, Description = "光意·四连矢" },
            ["220111"] = new SkillDefinition { Name = "Light Intent · Four-Arrow Strike (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光意·四连矢" },
            ["220203"] = new SkillDefinition { Name = "Light Intent · Four-Arrow Strike (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光意·四连矢" },
            ["2031109"] = new SkillDefinition { Name = "Bow - Luck", Type = SkillType.Damage, Element = ElementType.Light, Description = "幸运一击(弓箭手)" },
            ["220301"] = new SkillDefinition { Name = "Sharp Eye · Photonic Giant Arrow (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "锐眼·光能巨箭" },
            ["2352"] = new SkillDefinition { Name = "Celestial Eagle - Eagle", Type = SkillType.Damage, Element = ElementType.Light, Description = "天界雄鹰" },

            ["120401"] = new SkillDefinition { Name = "Rain beats down, and the tide rises. (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "雨打潮生" },
            ["1203"] = new SkillDefinition { Name = "Boys ATK_03 (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "雨打潮生" },
            ["120501"] = new SkillDefinition { Name = "Rain beats down, and the tide rises. (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "雨打潮生" },
            ["120201"] = new SkillDefinition { Name = "Rain beats down, and the tide rises. (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "雨打潮生" },
            ["120301"] = new SkillDefinition { Name = "Rain beats down, and the tide rises. (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "雨打潮生" },
            ...
            ["120902"] = new SkillDefinition { Name = "Virtual Body Ice Explosion (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "冰矛" },
            ["1262"] = new SkillDefinition { Name = "Ice Meteor Hologram", Type = SkillType.Damage, Element = ElementType.Ice, Description = "陨星风暴" },
            ["121501"] = new SkillDefinition { Name = "Virtual Dragon Claw Thunderfall (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "清淹绕珠" },
            ["1216"] = new SkillDefinition { Name = "Virtual Body Hockey Explosion (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "强化清淹绕珠" },
            ["1257"] = new SkillDefinition { Name = "Ice Storm Virtual Body (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "寒冰风暴" },
            ["1250"] = new SkillDefinition { Name = "Boys SKILL01_Virtual Body (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "水之涡流" },
            ...
            ["120901"] = new SkillDefinition { Name = "Virtual Body Trap Detection (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "贯穿冰矛" },
            ["2204241"] = new SkillDefinition { Name = "Frost Shock - Sub-Buff (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "冰霜冲击" },
            ["1261"] = new SkillDefinition { Name = "Ice Storm Virtual Body - Talent Edition (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "瞬发寒冰风暴" },

            ["2401"] = new SkillDefinition { Name = "Blade of Justice", Type = SkillType.Damage, Element = ElementType.Light, Description = "公正之剑" },
            ["2402"] = new SkillDefinition { Name = "Sword and Shield Normal Attack 02 (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "公正之剑" },
            ["2403"] = new SkillDefinition { Name = "Sword and Shield Normal Attack 03 (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "公正之剑" },
            ["2404"] = new SkillDefinition { Name = "Sword and Shield Normal Attack 04 (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "公正之剑" },
            ...
            ["2450"] = new SkillDefinition { Name = "Special Attack A Shockwave (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "光明冲击" },
            ["2410"] = new SkillDefinition { Name = "Judgment", Type = SkillType.Damage, Element = ElementType.Light, Description = "裁决" },
            ["2451"] = new SkillDefinition { Name = "Talent: Judgment (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "裁决(神圣触发)" },
            ...
            ["240101"] = new SkillDefinition { Name = "Throw the shield (T)", Type = SkillType.Damage, Element = ElementType.Light, Description = "投掷盾牌" },
            ...
            ["55404"] = new SkillDefinition { Name = "圣环 (T)", Type = SkillType.Heal, Element = ElementType.Light, Description = "圣环伤害/治疗(相同编号)" },
            ...
            ["240102"] = new SkillDefinition { Name = "Resolve for Light", Type = SkillType.Damage, Element = ElementType.Light, Description = "光明决心" },
            ...
            ["391006"] = new SkillDefinition { Name = "Ultimate Technique! Scatter Shot (Void Cannibal) Fishman Warrior - Passive - Trigger(T)", Type = SkillType.Damage, Element = ElementType.Dark, Description = "绝技! 纷乱飞弹(虚食人魔)" },
            ["1008440"] = new SkillDefinition { Name = "Arcane! Azure Gale", Type = SkillType.Damage, Element = ElementType.Wind, Description = "奥义! 沧澜风啸(飞鱼)" },
            ["391301"] = new SkillDefinition { Name = "Ultimate Skill! Electromagnetic Bomb (Gunner) Fishman Warrior - Passive - Trigger (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "绝技! 电磁爆弹(枪手)" },
            ["3913001"] = new SkillDefinition { Name = "Resonance - Shadow Legion Rifle - Virtual Body - Explosion Fishman Warrior - Passive - Trigger (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "绝技! 电磁爆弹(枪手)" },
            ...
            ["3210081"] = new SkillDefinition { Name = "Fishman Warrior - Passive - Triggered Fishman Warrior - Passive - Trigger (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "蜥蜴人猎手（被动）" },
            ...
            ["391008"] = new SkillDefinition { Name = "Variant Peak (Passive) (T)", Type = SkillType.Damage, Element = ElementType.Thunder, Description = "变异峰弩手（被动）" },
            ...
            ["199902"] = new SkillDefinition { Name = "Rage Burst Stone", Type = SkillType.Damage, Element = ElementType.Earth, Description = "岩盾" },
            ...
            ["1247"] = new SkillDefinition { Name = "Talent Trigger: Comet (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "天赋触发彗星" }, // ← 新增
            ["1249"] = new SkillDefinition { Name = "Staff Support Skill - Synergistic Ice Crystal (T)", Type = SkillType.Damage, Element = ElementType.Ice, Description = "协同冰晶" }, // ← 新增
            ...
            // Earth 系
            ["1517"] = new SkillDefinition { Name = "Iruuna FRACTURE_ATK (T)", Type = SkillType.Damage, Element = ElementType.Earth, Description = "掌控藤蔓-红光反制" }, // ← 新增
            ...
            ["1256"] = new SkillDefinition { Name = "Water Spout Virtual Entity", Type = SkillType.Damage, Element = ElementType.Wind, Description = "浪潮" }, // ← 新增
            ...
            ["1202"] = new SkillDefinition { Name = "Boys ATK_02 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "雨打潮生-转弯子弹" }, // ← 2025-08-19 新增（占位）
            ["1204"] = new SkillDefinition { Name = "Beuys ATK_04 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "雨打潮生-普攻1段" }, // ← 2025-08-19 新增（占位）
            ...
            ["1219"] = new SkillDefinition { Name = "Virtual Ice Tornado (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "冰龙卷" }, // ← 2025-08-19 新增（占位）
            ...
            ["1251"] = new SkillDefinition { Name = "Boys_SKILL01_Virtual Body (Ice) (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "水之涡流" }, // ← 2025-08-19 新增（占位）
            ["1258"] = new SkillDefinition { Name = "Talent - Ice Crystal Fall(T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "天赋-冰晶落" }, // ← 2025-08-19 新增（占位）
            ...
            ["1734"] = new SkillDefinition { Name = "Thunder Iaido Slash", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "雷霆居合斩" }, // ← 2025-08-19 新增（占位）
            ...
            ["1903"] = new SkillDefinition { Name = "Gerrard ATK_03 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "止战之锋3" }, // ← 2025-08-19 新增（占位）
            ["1904"] = new SkillDefinition { Name = "Gerrard ATK_04 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "止战之锋4" }, // ← 2025-08-19 新增（占位）
            ["1909"] = new SkillDefinition { Name = "Gerard EXAIR ATK (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "止战之锋（跳跃）" }, // ← 2025-08-19 新增（占位）
            ["1912"] = new SkillDefinition { Name = "Gerard FRACTURE_ATK (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "止战之锋-红光反制" }, // ← 2025-08-19 新增（占位）
            ...
            ["1932"] = new SkillDefinition { Name = "Shield Bash", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "护盾猛击" }, // ← 2025-08-19 新增（占位）
            ...
            ["1935"] = new SkillDefinition { Name = "Countercrush", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "格挡冲击-怒击" }, // ← 2025-08-19 新增（占位）
            ...
            ["2224"] = new SkillDefinition { Name = "Lethal Shot", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "夺命射击-四连矢" }, // ← 2025-08-19 新增（占位）
            ...
            ["2240"] = new SkillDefinition { Name = "Sky Piercing Star Strike", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "天翔贯星击-强化怒涛射击" }, // ← 2025-08-19 新增（占位）
            ...
            ["2290"] = new SkillDefinition { Name = "Rotroani - Bow - Monster Gathering Virtual Entity (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "锐眼·光能巨箭-聚怪(天赋)" }, // ← 2025-08-19 新增（占位）
            ...
            ["2296"] = new SkillDefinition { Name = "Phantom Eagle", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "幻影雄鹰" }, // ← 2025-08-19 新增（占位）
            ...
            ["2314"] = new SkillDefinition { Name = "Rock the Stage", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "升格·劲爆全场" }, // ← 2025-08-19 新增（占位）
            ...
            ["2320"] = new SkillDefinition { Name = "Flame Blast", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "音塔爆炎冲击" }, // ← 2025-08-19 新增（占位）
            ["2329"] = new SkillDefinition { Name = "Beat Performer Yanwu Performer (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "炎舞奏者" }, // ← 2025-08-19 新增（占位）
            ["2330"] = new SkillDefinition { Name = "Beat Performer Yanwu Performer Enhancement (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "火柱冲击-炎舞奏者强化" }, // ← 2025-08-19 新增（占位）
            ["2331"] = new SkillDefinition { Name = "Beat Performer's Soundwave Blaze (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "音浪烈焰" }, // ← 2025-08-19 新增（占位）
            ...
            ["3698"] = new SkillDefinition { Name = "Lucky Meteorite Virtual Entity - Active (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "风哥布林王(被动)" }, // ← 2025-08-19 新增（占位）
            ...
            ["21418"] = new SkillDefinition { Name = "Therapeutic effect (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "鹿之奔袭" }, // ← 2025-08-19 新增（占位）
            ["21427"] = new SkillDefinition { Name = "Basic Attack: 1-hit Health Regeneration (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "惩击奶空A1段" }, // ← 2025-08-19 新增（占位）
            ["21428"] = new SkillDefinition { Name = "Basic Attack: 2-stage health regeneration (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "惩击奶空A2段" }, // ← 2025-08-19 新增（占位）
            ["21429"] = new SkillDefinition { Name = "Basic Attack: 3-hit health regeneration (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "惩击奶空A3段" }, // ← 2025-08-19 新增（占位）
            ["21430"] = new SkillDefinition { Name = "Basic Attack: 4-hit health regeneration (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "惩击奶空A4段" }, // ← 2025-08-19 新增（占位）
            ["27009"] = new SkillDefinition { Name = "Weakness Strike A (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "冰箱BUFF" }, // ← 2025-08-19 新增（占位）
            ["50036"] = new SkillDefinition { Name = "Weakness Exploitation (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "弱点打击" }, // ← 2025-08-19 新增（占位）
            ["50037"] = new SkillDefinition { Name = "Block and Counterattack (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "格挡反击" }, // ← 2025-08-19 新增（占位）
            ["50049"] = new SkillDefinition { Name = "Sandstone Cloak (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "砂石斗篷（持续）" }, // ← 2025-08-19 新增（占位）
            ["50068"] = new SkillDefinition { Name = "Block and Counterattack -- Powerful (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "格挡反击--强" }, // ← 2025-08-19 新增（占位）
            ...
            ["55238"] = new SkillDefinition { Name = "Bow - Ultimate Gravity", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "弓-大招引力" }, // ← 2025-08-19 新增（占位）
            ...
            ["55240"] = new SkillDefinition { Name = "Light Energy Bombardment Damage Zone (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "光能轰炸伤害区域BUFF" }, // ← 2025-08-19 新增（占位）
            ["55328"] = new SkillDefinition { Name = "The Five-Piece Ensemble's Double Performance Captivates the Crowd (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "万众瞩目激涌五重奏弹奏翻倍" }, // ← 2025-08-19 新增（占位）
            ["55335"] = new SkillDefinition { Name = "All Eyes on the Stage, Passion in Full Swing: Phase 3 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "万众瞩目热情挥洒3阶段" }, // ← 2025-08-19 新增（占位）
            ["55344"] = new SkillDefinition { Name = "Base Healing of Ultimate Ability (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "升格·劲爆全场" }, // ← 2025-08-19 新增（占位）
            ...
            ["100730"] = new SkillDefinition { Name = "Resonance - Frenzy Shooter (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "哥布林弩手主动" }, // ← 2025-08-19 新增（占位）
            ...
            ["101112"] = new SkillDefinition { Name = "Companion Eagle Quick Spin", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "宠物雄鹰快速回旋" }, // ← 2025-08-19 新增（占位）
            ["141104"] = new SkillDefinition { Name = "The hornet stings in close combat. (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "变异蜂主动a1" }, // ← 2025-08-19 新增（占位）
            ["149904"] = new SkillDefinition { Name = "Tina's Instant Tornado (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "蒂娜龙卷" }, // ← 2025-08-19 新增（占位）
            ["179904"] = new SkillDefinition { Name = "Orvella Flying Thunder God (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "神影斩-最后一击" }, // ← 2025-08-19 新增（占位）
            ...
            ["220105"] = new SkillDefinition { Name = "Light-Tracking Arrow (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "光追箭" }, // ← 2025-08-19 新增（占位）
            ["220106"] = new SkillDefinition { Name = "Airborne Shooting (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "空中射击" }, // ← 2025-08-19 新增（占位）
            ["220107"] = new SkillDefinition { Name = "Magic Arrow (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "魔法箭矢" }, // ← 2025-08-19 新增（占位）
            ...
            ["221101"] = new SkillDefinition { Name = "Bullseye - Red Light Countermeasure (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "弹无虚发-红光反制" }, // ← 2025-08-19 新增（占位）
            ["230106"] = new SkillDefinition { Name = "Fiery Notes (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "烈焰音符伤害" }, // ← 2025-08-19 新增（占位）
            ["391001"] = new SkillDefinition { Name = "Ultimate Move! Scatter Shot (Void Eater) 1 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技! 纷乱飞弹(虚蚀食人魔)1" }, // ← 2025-08-19 新增（占位）
            ["391002"] = new SkillDefinition { Name = "Ultimate Technique! Scatter Shot (Void-Eaten Ogre) 2 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技! 纷乱飞弹(虚蚀食人魔)2" }, // ← 2025-08-19 新增（占位）
            ["391003"] = new SkillDefinition { Name = "Ultimate Technique! Scatter Shot (Void-Eaten Ogre) 3 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技! 纷乱飞弹(虚蚀食人魔)3" }, // ← 2025-08-19 新增（占位）
            ["391004"] = new SkillDefinition { Name = "Ultimate Move! Scatter Shot (Void Eater) 4 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技! 纷乱飞弹(虚蚀食人魔)4" }, // ← 2025-08-19 新增（占位）
            ["391005"] = new SkillDefinition { Name = "Ultimate Move! Scatter Shot (Void-Corrupted Ogre) 5 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技! 纷乱飞弹(虚蚀食人魔)5" }, // ← 2025-08-19 新增（占位）
            ...
            ["701001"] = new SkillDefinition { Name = "The device comes with a built-in buff. (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "虚蚀之影爆炸" }, // ← 2025-08-19 新增（占位）
            ["701002"] = new SkillDefinition { Name = "Installation: Phantom Erosion Explosion Performance 01 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "虚蚀波动爆炸" }, // ← 2025-08-19 新增（占位）
            ...
            ["1700824"] = new SkillDefinition { Name = "Pet - Ground Fox Sweep (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "甩尾" }, // ← 2025-08-19 新增（占位）
            ...
            ["1700826"] = new SkillDefinition { Name = "Companion - Powerful Pounce", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "狂野召唤" }, // ← 2025-08-19 新增（占位）
            ...
            ["2002853"] = new SkillDefinition { Name = "meteorite (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "绝技！碎星陨落（火哥）" }, // ← 2025-08-19 新增（占位）
            ...
            ["2110083"] = new SkillDefinition { Name = "Raging Flame Healing (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "火魔治疗" }, // ← 2025-08-19 新增（占位）
            ["2110085"] = new SkillDefinition { Name = "Seed of Thunder and Lightning (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "雷电之种(奥尔维拉)" }, // ← 2025-08-19 新增（占位）
            ...
            ["2110099"] = new SkillDefinition { Name = "Venomous Hive - dot Vulnerability (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "剧毒蜂巢（持续）" }, // ← 2025-08-19 新增（占位）
            ...
            ["2201410"] = new SkillDefinition { Name = "Sand and Gravel Recovery (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "砂石复苏" }, // ← 2025-08-19 新增（占位）
            ...
            ["2201570"] = new SkillDefinition { Name = "Rock Protection (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "岩护" }, // ← 2025-08-19 新增（占位）
            ...
            ["2202271"] = new SkillDefinition { Name = "Divine Light Descends active buff (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "天降圣光生效BUFF" }, // ← 2025-08-19 新增（占位）
            ...
            ["2203101"] = new SkillDefinition { Name = "Demon Wolf's Bite_Life Draining Away (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "生命流失" }, // ← 2025-08-19 新增（占位）
            ...
            ["2203302"] = new SkillDefinition { Name = "Life Drain - Sub-Buff 2 (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "生命流失（扫尾引爆）" }, // ← 2025-08-19 新增（占位）
            ...
            ["2204320"] = new SkillDefinition { Name = "Cold Pulse (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "冰冷脉冲" }, // ← 2025-08-19 新增（占位）
            ...
            ["2207500"] = new SkillDefinition { Name = "Extreme Intent Captivates the World (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "极意万众瞩目" }, // ← 2025-08-19 新增（占位）
            ["2207660"] = new SkillDefinition { Name = "Extreme Intent Captivates the World (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "极意万众瞩目" }, // ← 2025-08-19 新增（占位）
            ...
            ["3001170"] = new SkillDefinition { Name = "Void Erosion Wave", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "虚蚀波动回血" }, // ← 2025-08-19 新增（占位）
            ...
            ["3210031"] = new SkillDefinition { Name = "Thunderous Cannibal - Passive - Triggered (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "雷魔被动" }, // ← 2025-08-19 新增（占位）
            ["3210051"] = new SkillDefinition { Name = "Bandit Chieftain - Passive - Child Buff DOT (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "山贼被动" }, // ← 2025-08-19 新增（占位）
            ["3210061"] = new SkillDefinition { Name = "Sergeant Muk - Passive - Triggered (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "姆克兵长被动" }, // ← 2025-08-19 新增（占位）
            ["3210092"] = new SkillDefinition { Name = "Lizard King - Tidal Force Triggered (T)", Type = SkillType.Unknown, Element = ElementType.Unknown, Description = "蜥蜴人王被动" }, // ← 2025-08-19 新增（占位）
